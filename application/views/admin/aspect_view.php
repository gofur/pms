...
<div class="row">
	<div class="span12">
		...
		echo anchor('admin/aspect/add','<i class="icon-plus"></i>',' class="fancybox btn pull-right" data-fancybox-type="iframe" title="Add Aspect"');?> 
	</div>
</div>
<div class="row">
	<div class="span12">
		<table class="table datatable table-bordered table-striped table-hover">
			...
			foreach ($aspect as $row) {
				...
				echo '<td>'.anchor('admin/aspect/edit/'.$row->aspect_id,'<i class="icon-pencil"></i>','title="Edit"  class="fancybox" data-fancybox-type="iframe"').'</td>';
				echo '<td>'.anchor('admin/aspect/delimit/'.$row->aspect_id,'<i class="icon-ban-circle"></i>', 'title="Delimit"  class="fancybox" data-fancybox-type="iframe"').'</td>';
				echo '</tr>';
			}
			?></tbody>
		</table>
