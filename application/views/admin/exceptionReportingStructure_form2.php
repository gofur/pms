...
<div class="row">
	...
	<div class="span10"><?php echo form_input('TxtStartDate', date('Y-m-d'), 'class="input-small" id="TxtStartDate"');?></div>
...
<div class="row">
	<div class="span6">
		...
		<div class="row">
			<div class="span2">SAP/nonSAP</div>
			<div class="span4">
				<select name="slcStatus" id="slcStatus" class="input-small">
					<option value=""></option>
					<option value="0">nonSAP</option>
	...
	<div class="span6">
		...
		<div class="row">
			<div class="span2">SAP/nonSAP</div>
			<div class="span4">
				<select name="slcStatus_sub" id="slcStatus_sub" class="input-small">
					<option value=""></option>
					<option value="0">nonSAP</option>
					<option value="1">SAP</option>
				</select>
