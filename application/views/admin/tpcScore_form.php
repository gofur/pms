...
<div class="row">
	<div class="span2">Low :</div>
	<div class="span10"><input type="text" class="input-small" name="TxtTPCLow" id="TxtTPCLow" value="<?php echo isset($old->TPCLow)?$old->TPCLow:''?>"> </div>
</div>
<div class="row">
	<div class="span2">High :</div>
	<div class="span10"><input type="text" class="input-small" name="TxtTPCHigh" id="TxtTPCHigh" value="<?php echo isset($old->TPCHigh)?$old->TPCHigh:''?>"> </div>
</div>
