	...
	<div class="span7">
		...
		switch ($notif) {
			...
			case 2:
	  		...
	  		echo '<center>Wrong password or username</center>';
				echo '</div>';
				break;
		}
		?>
...
<div class="row">
	<div class="span7 title-login">
		<center><h3>PERFORMANCE MANAGEMENT SYSTEM</h3></center>
	</div>
</div>
	...
	<div class="row">
		<div class="span7">
			...
			echo form_open('account/login_process',$att);
			...
			?>
				...
				<div class="row span2">
					...
					<div class="span4">
						<label>Password :</label> <input type="password" class="required"  name="txtPass" id="txtPass" placeholder="Password">
					</div>
					<div class="span4">
						<button type="submit" class="btn btn-primary">Login</button>
						<?php echo anchor('account/forgot', 'Forgot Password', 'class="btn btn-link"'); ?>
					</div>
					<div class="span2">
					</div>
				</div>
