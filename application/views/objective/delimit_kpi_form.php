...
<div class="row">
	...
	<div class="span8">
		<input type="hidden" name="hiddenGenericKPIID" value="<?=$old->KPIGenericID?>" />
		<select name="SlcGeneric" id="SlcGeneric" class="input-large" disabled="disabled">
		<option value=""></option>
		<?php
...
<div id="SectionGen">
	<div class="row">
		...
		<div class="span3"><input type="text" readonly="readonly" name="TxtKPI" id="TxtKPI" class="input-large" value="<?php echo isset($old->KPI)?$old->KPI:'' ;?>"></div>
		<div class="span2">Description</div>
		<div class="span3"><textarea name="TxtDesc" id="TxtDesc" readonly="readonly" class="input-large" rows="3"><?php echo isset($old->Description)?$old->Description:'' ;?></textarea></div>
	</div>
	<div class="row">
		<div class="span2">Unit</div>
		<div class="span3">
			<input type="hidden" name="hiddenSatuanID" value="<?=$old->SatuanID?>" />
			<select name="SlcSatuan" id="SlcSatuan" class="input-medium" disabled="disabled">
			<?php
		...
		<div class="span3">
			<input type="hidden" name="hiddenFormulaID" value="<?=$old->PCFormulaID?>" />
			<select name="SlcFormula" id="SlcFormula" class="input-medium" disabled="disabled">
			<?php
	...
	<div class="row">
		...
		<div class="span8">
			<input type="hidden" name="hiddenYTDID" value="<?=$old->YTDID?>" />
			<select name="SlcYTD" id="SlcYTD" class="input-medium" disabled="disabled">
			<?php
...
<div class="row">
	...
	<div class="span3"><input type="text" name="TxtWeight" id="TxtWeight" class="input-small" value="<?php echo isset($old->Bobot)?$old->Bobot:'0' ;?>"></div>
	<div class="span2">Baseline</div>
	<div class="span3"><input type="text" name="TxtBaseline" id="TxtBaseline" class="input-small" readonly="readonly" value="<?php echo isset($old->Baseline)?$old->Baseline:'0' ;?>"></div>
</div>
<div class="row">
	<div class="span2">Target</div>
	<div class="span8"><input type="text" name="TxtTarget" readonly="readonly" id="TxtTarget" class="input-small" value="<?php echo isset($old->TargetAkhirTahun)?thousand_separator($old->TargetAkhirTahun):'0' ;?>"></div>
</div>
<div class="row">
