...
<div class="row">
	...
	<div class="span3"><input type="text"  name="TxtEndDate" id="TxtEndDate" readonly class="input-small"  value="<?php echo isset($old->KPI_EndDate)?substr($old->KPI_EndDate,0,10):substr($Periode->EndDate,0,10)?>"></div>
</div>
<div class="row">
...
<div class="row">
	...
	<div class="span8"><input type="text" name="TxtTarget" id="TxtTarget" class="input-small " value="<?php echo isset($old->TargetAkhirTahun)?thousand_separator($old->TargetAkhirTahun):'0' ;?>"></div>
</div>
<div class="row">
