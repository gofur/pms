...
<div id="div-generic">
	...
	<div class="row">
		...
		<div class="span8"><?php echo form_textarea('txt_desc', $kpi_desc, 'id="txt_desc" class="input-xlarge" rows="3"'); ?></div>
	</div>
	<div class="row">
...
<div class="row">
	...
	<div class="span8"><?php echo form_number('nm_weight', $weight, 'id="nm_weight" class="input-small" min="0" min="100" step="0.01"'); ?></div>
</div>
<div class="row">
	<div class="span2">Baseline</div>
	<div class="span8"><?php echo form_input('nm_base', $base, 'id="nm_base" class="input-small" min="0" step="0.01"'); ?></div>
</div>
			...
			<tbody>
				...
				for ($y=0; $y < 3 ; $y++) {
					...
					for ($x=1; $x <=4 ; $x++) {
						...
						echo '<td>';
						echo form_number('nm_target_'.$month_id,round($targets[$month_id],2),'id="nm_target_'.$month_id.'" class="'.$nm_class.'" step="0.01"');
						echo '</td>';
					}
					echo '</tr>';
				}
