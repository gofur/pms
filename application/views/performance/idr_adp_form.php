...
<div class="row">
	<div class="span3">Start Date :</div>
	<div class="span9"><input <?php echo isset($old->BeginDate)?'readonly="readonly"':''?> type="text" class="input-small" name="TxtRealizationBeginDate" id="TxtRealizationBeginDate" value="<?php echo isset($old->BeginDate)?substr($old->BeginDate,0,10):date('Y/m/d')?>"> </div>
</div>
<div class="row">
	<div class="span3">End Date :</div>
	<div class="span9"><input type="text" class="input-small" name="TxtRealizationEndDate" id="TxtRealizationEndDate" value="<?php echo isset($old->EndDate)?substr($old->EndDate,0,10) :date('Y/m/d')?>"> </div>
</div>
<div class="row">
	<div class="span3">Realization Investment</div>
	<div class="span9">Rp. <input type="text" class="input-large" name="TxtRealizationInvestment" id="TxtRealizationInvestment" value=""></div>
</div>
<div class="row">
