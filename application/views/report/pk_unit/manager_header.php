...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$('#btn_view').click(function(event) {
			...
			// alert('test');
			$.ajax({
      	url: base_url + 'report/pk_unit_report/show_achv',
      	type: 'POST',
      	data: {
      		org_id : org_id,
      		post_id : post_id,
      ...
      .done(function(msg) {
      	$("#box-list").html(msg);
      	$.ajax({
	      	url: base_url + 'report/pk_unit_report/show_bellcurve/before',
	      	type: 'POST',
	      	data: {
	      		org_id : org_id,
	      		post_id : post_id,
	      ...
	      .done(function(msg) {
	      	$("#box-bellcurve-before").html(msg);
		      $.ajax({
		      	url: base_url + 'report/pk_unit_report/show_bellcurve/after',
		      	type: 'POST',
		      	data: {
		      		org_id : org_id,
		      		post_id : post_id,
