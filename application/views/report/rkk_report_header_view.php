	...
	<div class="span6">
		...
		<div class="row">
			...
			else
			{
				...
				echo form_open('report/rkk_report/',$attributes);
	...
	<div class="span6">
      ...
      <thead>
        <tr>
          <th>Total RKK</th>
          <th>Submitted RKK</th>
          <th>Not Yet Submitted RKK</th>
          <th>% of Submitted RKK</th>
          </tr>
      </thead>
      <tbody>
        ...
        <?php
			if(isset($subordinate)){
				...
				if(isset($total_rkk))
				{
					echo '<tr><td>'.$total_rkk.'</td>';
					echo '<td>'.anchor($link['view_submited_rkk'],$total_rkk_submitted,'title="View Submitted RKK"  class="fancybox-nonrefresh" data-fancybox-type="iframe"').'</td>';
					echo '<td>'.anchor($link['view_not_submited_rkk'],$total_rkk_not_submitted,'title="View Not Submitted RKK"  class="fancybox-nonrefresh" data-fancybox-type="iframe"').'</td>';
					echo '<td>'.$total_average_rkk.'</td></tr>';
				}
			}
		?>
